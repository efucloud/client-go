	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RbacV1alpha1().KubeUsers().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RbacV1alpha1().KubeUsers().Watch(context.TODO(), options)
			},
		},
		&rbacv1alpha1.KubeUser{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *kubeUserInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rbacv1alpha1.KubeUser{}, f.defaultInformer)
}
