...
type WorkspaceRoleInformer interface {
	...
	Lister() v1alpha1.WorkspaceRoleLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RbacV1alpha1().WorkspaceRoles().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RbacV1alpha1().WorkspaceRoles().Watch(context.TODO(), options)
			},
		},
		&rbacv1alpha1.WorkspaceRole{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *workspaceRoleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rbacv1alpha1.WorkspaceRole{}, f.defaultInformer)
}

func (f *workspaceRoleInformer) Lister() v1alpha1.WorkspaceRoleLister {
	return v1alpha1.NewWorkspaceRoleLister(f.Informer().GetIndexer())
}
