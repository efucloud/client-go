...
type WorkspaceRoleInterface interface {
	...
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.WorkspaceRoleList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.WorkspaceRole, err error)
...
func newWorkspaceRoles(c *RbacV1alpha1Client) *workspaceRoles {
...
func (c *workspaceRoles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.WorkspaceRole, err error) {
...
func (c *workspaceRoles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.WorkspaceRoleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.WorkspaceRoleList{}
	err = c.client.Get().
		Resource("workspaceroles").
...
func (c *workspaceRoles) Create(ctx context.Context, workspaceRole *v1alpha1.WorkspaceRole, opts v1.CreateOptions) (result *v1alpha1.WorkspaceRole, err error) {
	result = &v1alpha1.WorkspaceRole{}
	err = c.client.Post().
		Resource("workspaceroles").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *workspaceRoles) Update(ctx context.Context, workspaceRole *v1alpha1.WorkspaceRole, opts v1.UpdateOptions) (result *v1alpha1.WorkspaceRole, err error) {
	result = &v1alpha1.WorkspaceRole{}
	err = c.client.Put().
		Resource("workspaceroles").
...
func (c *workspaceRoles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.WorkspaceRole, err error) {
	result = &v1alpha1.WorkspaceRole{}
