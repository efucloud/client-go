...
var clusterconfigsResource = schema.GroupVersionResource{Group: "cluster.efucloud.com", Version: "v1alpha1", Resource: "clusterconfigs"}

var clusterconfigsKind = schema.GroupVersionKind{Group: "cluster.efucloud.com", Version: "v1alpha1", Kind: "ClusterConfig"}
...
func (c *FakeClusterConfigs) UpdateStatus(ctx context.Context, clusterConfig *v1alpha1.ClusterConfig, opts v1.UpdateOptions) (*v1alpha1.ClusterConfig, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(clusterconfigsResource, "status", clusterConfig), &v1alpha1.ClusterConfig{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ClusterConfig), err
...
func (c *FakeClusterConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(clusterconfigsResource, name, opts), &v1alpha1.ClusterConfig{})
	return err
}
