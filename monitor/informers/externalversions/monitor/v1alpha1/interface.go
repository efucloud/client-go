...
type Interface interface {
	// ClusterDashboards returns a ClusterDashboardInformer.
...
// ClusterDashboards returns a ClusterDashboardInformer.
func (v *version) ClusterDashboards() ClusterDashboardInformer {
	return &clusterDashboardInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}
...
// WorkspaceDashboards returns a WorkspaceDashboardInformer.
func (v *version) WorkspaceDashboards() WorkspaceDashboardInformer {
	return &workspaceDashboardInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}
