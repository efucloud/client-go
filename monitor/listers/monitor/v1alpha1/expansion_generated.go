...
// ClusterDashboardListerExpansion allows custom methods to be added to
// ClusterDashboardLister.
type ClusterDashboardListerExpansion interface{}

// ProjectArchitectureListerExpansion allows custom methods to be added to
// ProjectArchitectureLister.
type ProjectArchitectureListerExpansion interface{}

// ProjectArchitectureNamespaceListerExpansion allows custom methods to be added to
