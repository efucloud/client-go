...
import (
	...
	"github.com/efucloud/client-go/monitor/clientset/versioned/scheme"
...
// MonitorV1alpha1Client is used to interact with features provided by the monitor.efucloud.com group.
type MonitorV1alpha1Client struct {
	restClient rest.Interface
}

func (c *MonitorV1alpha1Client) ClusterDashboards() ClusterDashboardInterface {
	return newClusterDashboards(c)
}
...
func (c *MonitorV1alpha1Client) WorkspaceDashboards() WorkspaceDashboardInterface {
	return newWorkspaceDashboards(c)
}
